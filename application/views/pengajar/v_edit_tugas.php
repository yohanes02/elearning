			...
			<div class="row">
				...
				<div class="col-lg-11">
					<div class="form-floating">
						<input id="title_tugas" type="text" class="form-control" value="Tugas 1" placeholder="test">
			...
			<div class="row mt-2">
				...
				<div class="col-lg-11">
					<div class="form-floating">
						...
						<textarea id="description_tugas" class="form-control" placeholder="test" style="height: 200px;">Tugas 1 Deskripsi</textarea>
