      ...
      <div class="container w-50 px-5 text-center">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?= site_url() ?>auth/changePassword" class="text-start" method="post">
              <div class="mb-3">
                <label for="s" class="form-label">New Password</label>
                <div class="input-group">
                  <input id="new_pass" name="new_pass" type="password" class="form-control" placeholder="Password">
